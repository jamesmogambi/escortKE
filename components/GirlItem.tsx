        ...
        >
            <Link href={path}>
                ...
                <div className="p-4">
                    ...
                    <div
                        className="flex  w-full flex-nowrap overflow-hidden   border-b-[0.2px] border-gray-500 pb-2.5 font-medium lg:items-center justify-between">
            ...
            <div className="fiex top-0 -left-2 absolute z-10">
                {videos.length > 0 ? (
                    ...
                    <div
                        className=" hidden lg:flex items-center rounded-br-lg gap-4 p-2 px-6 bg-stone-300/65   text-black/60">

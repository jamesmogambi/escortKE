          ...
          <SheetContent className="text-white border-none pl-2.5  bg-dark-slate">
            <SheetHeader className="mt-8">
              {!isLoggedIn ? (
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger className="bg-primary mt-6 w-auto group text-white rounded-md flex items-center gap-2 p-3 px-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    ...
                    <span className="text-sm text-nowrap group-hover:font-bold uppercase font-medium">
                      account settings
                    </span>

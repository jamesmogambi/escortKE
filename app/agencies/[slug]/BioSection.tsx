...
import RenderEditorContent from "@/app/girl/RenderEditorContent";
import PhonePicker from "@/app/girl/PhonePicker";
import AboutTabs from "./AboutTabs";

interface Prop {
  company: any;
}
const BioSection = ({ company }: Prop) => {
  const {
    description,
    phone,
    address,
  ...
  return (
    <div>
      <RenderEditorContent html={description} />

      <PhonePicker phone={contactPhone} className="my-6" />
      ...
      <AboutTabs className="my-12 mb-0  " agency={company} />
